...
const projects = [
  ...
  },
  {
    id: 9,
    category: "civil",
    title: "Smart Living Home Project",
    ...
    tag: "Completed",
    tagColor: "#10b981",
    desc: "Modern residential property built with innovative design concepts and high-quality construction for everyday comfort.",
    image: cons2,
  },
  {
    id: 10,
    category: "solar",
    title: "Sustainable Home Solar Project",
    location: "Samastipur, Bihar",
    year: "2024",
    area: "10 KW",
    featured: true,
    tag: "Ongoing",
    tagColor: "#6366f1",
    desc: "Eco-friendly rooftop solar setup that helps homeowners reduce grid electricity consumption while supporting a greener future.",
    image: sl1,
  },
